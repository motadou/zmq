...
protected:
    ...
    //  Derived object can use these functions to send commands to other objects.
    void send_stop ();
    ...
    //  These handlers can be overridden by the derived objects. They are called when command arrives from another thread.
